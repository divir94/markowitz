...
(function() {
    ...
    var r, E = document,
        ...
        Wb =
        Va && parseInt(Ga.split("Firefox/")[1], 10) < 4,
        ma = !da && !Da && !!E.createElement("canvas").getContext,
        Wa, $a, Sb = {},
        Hb = 0,
        kb, F, ka, Fa, Ib, H, ga = function() {
            return r
        },
        ha = [],
        fb = 0,
        ...
        Yb = "stroke-width",
        ea, lb, ub, jb, yb, zb, Ab, bb, cb, db, Ob, Pb, Bb, Cb, Db, I = {},
        z;
        ...
        zIndexSetter: function(a, b) {
            ...
            if (this.added) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = W(e, "zIndex"), e !== g && (C(f) > a || !s(a) && s(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
                        ...
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length >
                                        1 || f || o.length > 1 && k.whiteSpace !== "nowrap", p, A, r, s = [], w = N(t), v = 1, x = a.rotation, y = e, B = y.length;
                                    (n || q) && (o.length || s.length);) a.rotation = 0, p = a.getBBox(!0), r = p.width, !da && c.forExport && (r = c.measureSpanWidth(t.firstChild.data, a.styles)), p = r > l, A === void 0 && (A = p), q && A ? (B /= 2, y === "" || !p && B < 0.5 ? o = [] : (p && (A = !0), y = e.substring(0, y.length + (p ? -1 : 1) * ya(B)), o = [y + "â€¦"], t.removeChild(t.firstChild))) : !p || o.length === 1 ? (o = s, s = [], o.length && (v++, t = E.createElementNS(Ha, "tspan"), W(t, {
                                        dy: w,
                                        x: j
    ...
    if (!da && !ma) G = {
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                var k,
                    l, m = a.linearGradient || a.radialGradient,
                    o, q, t, J, p, u = "",
                    a = a.stops,
                    A, oa = [],
                    r = function() {
                ...
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 ||
                        m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, u = 'angle="' + (90 - Y.atan((m - a) / (o - c)) * 180 / va) + '"', r();
                    else {
                        var j = m.r,
                            s = j * 2,
                            w = j * 2,
                ...
                '"/>'
            ], aa(this.prepVML(h), null, null, b), j = f.get("rgb");
            else {
    ...
    O.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ma(h, this);
                ...
                a >= 1E3)
                for (; f-- && g === r;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
    ...
    O.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = w(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = X(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 &&
                !l; f++) {
                i = e.length;
    ...
    Xa.prototype = {
        ...
        runPointActions: function(a) {
            ...
            else g = i && i.tooltipOptions.followPointer, e && g && !e.isHidden && (g = e.getAnchor([{}], a), e.updatePosition({
                plotX: g[0],
                plotY: g[1]
            }));
    ...
    if (T.PointerEvent || T.MSPointerEvent) {
        ...
        S(Xa.prototype, "init", function(a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && M(b.container, {
                "-ms-touch-action": Z,
                "touch-action": Z
            })
        });
    ...
    G = z.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            var e = this.chart.renderer,
                f = this.legendGroup,
                a = a.baseline - w(e.fontMetrics(a.options.itemStyle.fontSize,
                    this.legendItem).b * 0.3),
                g;
            if (b.lineWidth) {
                g = {
    ...
    P.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) n(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (sa(k)) {
                        ...
                        if (J)
                            for (c = 0; c < h; c++) i = a[c], q[c] = i[0], t[c] = i.slice(1, J + 1);
                        else
        ...
        render: function() {
            var a = this,
                b = a.chart,
                c, d = a.options,
                e = (c = d.animation) && !!a.animate && b.renderer.isSVG && p(c.duration,
                    500) || 0,
    ...
    Ca = ja(P, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== r && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = s(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (gb(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (j) h.graphic =
                    j.destroy()
            })
        },
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (m > 0) {
                        ...
                        for (L = 0; L < K; L++) {
                            ...
                            if (F < L && G[L] !== null) F = L;
                                ...
                                for (u < K - L + F && G[L] !== null && (F = u - K + L); G[F] === null;) F++;
                            M.push({
                                i: F,
                                y: G[F]
                            });
            ...
            if (Ea(C) === 0 || this.verifyDataLabelOverflow(C)) this.placeDataLabels(), s && g && n(this.points, function(b) {
                ...
                if ((r = b.dataLabel) && r._pos) D =
                    r._attr.visibility, y = r.connX, z = r.connY, k = l ? ["M", y + (A[6] === "left" ? 5 : -5), z, "C", y, z, 2 * A[2] - A[4], 2 * A[3] - A[5], A[2], A[3], "L", A[4], A[5]] : ["M", y + (A[6] === "left" ? 5 : -5), z, "L", A[2], A[3], "L", A[4], A[5]], j ? (j.animate({
                        d: k
    ...
    S(O.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (!this.options.ordinal &&
            !this.options.breaks || !f || f.length < 3 || c === r) return a.call(this, b, c, d, e);
            ...
            if (a.options.ordinal || a.options.breaks) {
                n(a.series, function(d, e) {
                    if (d.visible !== !1 && (d.takeOrdinalPosition !== !1 || a.options.breaks))
                        if (c = c.concat(d.processedXData),
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (R(f) > 1) k && n(k, function(a) {
                    ...
                    q = m), m = q.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [o.apply(k, [i, !0]) + f, !0]), l.apply(q, [o.apply(q, [j, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
                }), this.mouseDownX = d, M(this.container, {
                    cursor: "move"
                })
            } else e = !0
        } else e = !0;
    ...
    ca.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            for (; c[1] !== r && a[n] >= c[1] || n === i;)
                if (j = c.shift(), k = d.apply(0, m), k !== r && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                j = this.cropStart + n;
        ...
        drawPoints: function() {
            ...
            n(a.points, function(k) {
                if (k.plotY !== r) i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = w(k.plotX) - f, g = w(k.shapeArgs.width / 2), h = ["M", j, w(k.yBottom), "L", j, w(k.plotY)], k.open !==
                    null && (d = w(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = w(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.animate({
                        d: h
        ...
        drawPoints: function() {
            ...
            n(a.points, function(n) {
                ...
                if (n.plotY !== r) c = n.pointAttr[n.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, l = w(n.plotX) - k, e = n.plotOpen, f = n.plotClose, g = Y.min(e,
                    f), h = Y.max(e, f), q = w(n.shapeArgs.width / 2), i = w(g) !== w(n.plotY), j = h !== n.yBottom, g = w(g) + k, h = w(h) + k, o = ["M", l - q, h, "L", l - q, g, "L", l + q, g, "L", l + q, h, "Z", "M", l, g, "L", l, i ? w(n.plotY) : g, "M", l, h, "L", l, j ? w(n.yBottom) : h], m ? m.animate({
                    d: o
    ...
    I.flags = ja(I.column, {
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                o, n;
            for (j = c.length; j--;)
                if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? m : -m), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== r && (f = k.plotY + h + m - (l !== r && l * g.stackDistance)), o = l ? r : k.plotX + m, n = l ? r : k.plotY, l = k.graphic, f !== r && e >= 0 && !a) a =
    ...
    Eb.prototype = {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (y) this.navigatorGroup = l = f.g("navigator").attr({
                            ...
                            fill: r.maskFill
                        }).add(l), r.maskInside ? this.leftShade.css({
                            cursor: "ew-resize "
                    ...
                    if (t && k) this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        ...
                        width: j
                    }), g = n + b, h = a - G, h < u && (D = (u - h) / 2, h = u, g -= D), this.scrollbarPad = D, m[e]({
                        x: X(g) + G % 2 / 2,
                        width: h
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    w, x = eb ? 10 : 7;
                if (v > h && v < h + g + j)
                    if ((h = !a.scrollbarEnabled || v < h + g) && Y.abs(s - e - m) < x) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && Y.abs(s - f - m) < x) a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                else if (s > m + e - p && s < m + f + p) a.grabbedCenter = s, a.fixedWidth = r, i = s - e;
                else if (s > k && s < k + l) {
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) D(a,
                "updatedData", this.updatedDataHandler), a.userOptions.events = x(a.userOptions.event, {
        ...
        clickButton: function(a, b) {
            ...
            if (!(j === null || k ===
                ...
                if (q === "month" || q === "year") l = {
                    month: "Month",
                    year: "FullYear"
                }[q], o["set" + l](o["get" + l]() - t), l = o.getTime(), j = p(j, Number.MIN_VALUE), isNaN(l) || l < j ? (l = j, m = B(l + i, k)) : i = m - l;
